...
class DevotionalEndToEndReadingContractTest(unittest.TestCase):
    ...
    def test_ramcharitmanas_modes_cover_whole_page_passage_kanda_and_resume_reading(self):
        ...
        self.assertEqual(self.manas["canonical_reading_progress"]["completed_passages"], 31)
        self.assertEqual(self.manas["canonical_reading_progress"]["completed_source_units"], 165)
