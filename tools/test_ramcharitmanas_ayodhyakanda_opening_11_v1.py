...
class RamcharitmanasAyodhyakandaOpening11Tests(unittest.TestCase):
    ...
    def test_contract_counts_and_forward_endpoint_match(self) -> None:
        ...
        self.assertEqual(len(progress["completed_contiguous_batches"]), 3)
    ...
    def test_inventories_match_the_reviewed_selected_scope(self) -> None:
        ...
        self.assertEqual(mvp_lane["current"]["consumer_complete_contiguous_passages"], 92)
        self.assertEqual(mvp_lane["current"]["consumer_complete_source_units"], 491)
        self.assertEqual(mvp_lane["current"]["contiguous_forward_endpoint"], "Ayodhyakanda doha 22")
        self.assertEqual(coverage_lane["denominator"]["completed_contiguous_passages"], 92)
        self.assertEqual(coverage_lane["denominator"]["completed_source_units"], 491)
        self.assertEqual(coverage_lane["denominator"]["contiguous_forward_endpoint"], "Ayodhyakanda doha 22")
