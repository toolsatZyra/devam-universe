...
class RamcharitmanasAyodhyakandaOpening11Tests(unittest.TestCase):
    ...
    def test_contract_counts_and_forward_endpoint_match(self) -> None:
        ...
        self.assertEqual(len(progress["completed_contiguous_batches"]), 5)
    ...
    def test_inventories_match_the_reviewed_selected_scope(self) -> None:
        ...
        self.assertEqual(mvp_lane["current"]["consumer_complete_contiguous_passages"], 148)
        self.assertEqual(mvp_lane["current"]["consumer_complete_source_units"], 775)
        self.assertEqual(mvp_lane["current"]["contiguous_forward_endpoint"], "Ayodhyakanda doha 78")
        self.assertEqual(coverage_lane["denominator"]["completed_contiguous_passages"], 148)
        self.assertEqual(coverage_lane["denominator"]["completed_source_units"], 775)
        self.assertEqual(coverage_lane["denominator"]["contiguous_forward_endpoint"], "Ayodhyakanda doha 78")
