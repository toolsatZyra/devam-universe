...
class DevimahatmyaSemanticGraphCompilerTests(unittest.TestCase):
    def test_semantic_graph_migration_reconstructs_exactly(self) -> None:
        ...
        self.assertEqual(report["entity_count"], 20)
        self.assertEqual(report["preferred_name_count"], 60)
        self.assertEqual(report["bilingual_claim_count"], 40)
        self.assertEqual(report["relationship_count"], 20)
        self.assertEqual(report["evidence_passage_count"], 15)
    ...
    def test_semantic_graph_sql_preserves_evidence_and_claim_ceiling(self) -> None:
        ...
        self.assertIn("Pinned Devimahatmya source object set", sql)
