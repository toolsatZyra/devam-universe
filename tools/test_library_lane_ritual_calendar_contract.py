...
MAGHA_SHRADDHA_PACK = LANE / "packs" / "magha-shraddha-north-west-authority-router-2027-v1.json"
...
def test_authoring_progress_reconciles_to_frozen_v4_denominator():
    ...
    assert progress["completed_lane_ids"] == [
        ...
        "purnima-shraddha-north-west-authority-router-2027-v1",
        "pratipada-shraddha-north-west-authority-router-2027-v1",
        "dwitiya-shraddha-north-west-authority-router-2027-v1",
        "tritiya-shraddha-north-west-authority-router-2027-v1",
        "chaturthi-shraddha-north-west-authority-router-2027-v1",
        "panchami-shraddha-north-west-authority-router-2027-v1",
        "shashthi-shraddha-north-west-authority-router-2027-v1",
        "saptami-shraddha-north-west-authority-router-2027-v1",
        "ashtami-shraddha-north-west-authority-router-2027-v1",
        "navami-shraddha-north-west-authority-router-2027-v1",
        "dashami-shraddha-north-west-authority-router-2027-v1",
        "ekadashi-shraddha-north-west-authority-router-2027-v1",
        "chaturdashi-shraddha-north-west-authority-router-2027-v1",
        "pausha-purnima-recurring-household-2027-v1",
        "magha-purnima-recurring-household-2027-v1",
        "phalguna-purnima-recurring-household-2027-v1",
        "chaitra-purnima-recurring-household-2027-v1",
        "vaishakha-purnima-recurring-household-2027-v1",
        "jyeshtha-purnima-recurring-household-2027-v1",
        "ashadha-purnima-recurring-household-2027-v1",
        "shravana-purnima-recurring-household-2027-v1",
        "ashwina-purnima-recurring-household-2027-v1",
        "kartika-purnima-recurring-household-2027-v1",
        "margashirsha-purnima-recurring-household-2027-v1",
        "dhanu-sankranti-north-west-shared-household-2027-v1",
        "karka-sankranti-north-west-shared-household-2027-v1",
        "kumbha-sankranti-north-west-shared-household-2027-v1",
        "meena-sankranti-north-west-shared-household-2027-v1",
        "mesha-sankranti-north-west-shared-household-2027-v1",
        "mithuna-sankranti-north-west-shared-household-2027-v1",
        "simha-sankranti-north-west-shared-household-2027-v1",
        "tula-sankranti-north-west-shared-household-2027-v1",
        "vrishabha-sankranti-north-west-shared-household-2027-v1",
        "vrishchika-sankranti-north-west-shared-household-2027-v1",
        "chingam-sankramam-kerala-malayalam-solar-household-2027-v1",
        "dhanu-sankramam-kerala-malayalam-solar-household-2027-v1",
        "itavam-sankramam-kerala-malayalam-solar-household-2027-v1",
        "karkatakam-sankramam-kerala-malayalam-solar-household-2027-v1",
        "kumbham-sankramam-kerala-malayalam-solar-household-2027-v1",
        "makaram-sankramam-kerala-malayalam-solar-household-2027-v1",
        "meenam-sankramam-kerala-malayalam-solar-household-2027-v1",
        "metam-sankramam-kerala-malayalam-solar-household-2027-v1",
        "mithunam-sankramam-kerala-malayalam-solar-household-2027-v1",
        "thulam-sankramam-kerala-malayalam-solar-household-2027-v1",
        "vrischikam-sankramam-kerala-malayalam-solar-household-2027-v1",
        ...
        "kurma-dwadashi-telugu-calendar-household-2027-v1",
        "bhishma-dwadashi-telugu-calendar-household-2027-v1",
        "narasimha-dwadashi-telugu-calendar-household-2027-v1",
        "ramalakshmana-dwadashi-telugu-calendar-household-2027-v1",
        "vasudeva-dwadashi-telugu-calendar-household-2027-v1",
        "damodara-dwadashi-telugu-calendar-household-2027-v1",
        "kalki-dwadashi-telugu-calendar-household-2027-v1",
        "padmanabha-dwadashi-telugu-calendar-household-2027-v1",
        "yogeshwara-dwadashi-telugu-calendar-household-2027-v1",
        "matsya-dwadashi-telugu-calendar-household-2027-v1",
        "bachha-baras-dwadashi-gujarat-animal-safe-household-2027-v1",
        "thai-amavasai-regional-household-participant-2027-v1",
        "mauni-amavas-regional-household-participant-2027-v1",
        "dol-purnima-regional-household-participant-2027-v1",
        "chitra-pournami-regional-household-participant-2027-v1",
        "madana-pournami-regional-household-participant-2027-v1",
        "savitri-amabasya-regional-household-participant-2027-v1",
        "aadi-amavasai-regional-household-participant-2027-v1",
        "somavati-amavasya-regional-household-participant-2027-v1",
        "gamha-purnima-regional-household-participant-2027-v1",
        "pithori-amavasya-regional-household-participant-2027-v1",
        "mahalaya-amabasya-regional-household-participant-2027-v1",
        "mahalaya-amavasai-regional-household-participant-2027-v1",
        "sharad-purnima-regional-household-participant-2027-v1",
        "aadi-perukku-seasonal-household-participant-2027-v1",
        "bhogi-pandigai-seasonal-household-participant-2027-v1",
        "magh-bihu-seasonal-household-participant-2027-v1",
        "makaravilakku-seasonal-household-participant-2027-v1",
        "malayalam-new-year-seasonal-household-participant-2027-v1",
        "mandalakala-pooja-seasonal-household-participant-2027-v1",
        "mattu-pongal-seasonal-household-participant-2027-v1",
        "nutan-varsh-prarambha-seasonal-household-participant-2027-v1",
        "pohela-boishakha-seasonal-household-participant-2027-v1",
        "pongal-seasonal-household-participant-2027-v1",
        "puthandu-seasonal-household-participant-2027-v1",
        "vishu-seasonal-household-participant-2027-v1",
        "thai-pusam-south-devotional-household-participant-2027-v1",
        "panguni-uthiram-south-devotional-household-participant-2027-v1",
        "ramanuja-jayanthi-south-devotional-household-participant-2027-v1",
        "vaikasi-visakam-south-devotional-household-participant-2027-v1",
        "andal-jayanthi-south-devotional-household-participant-2027-v1",
        "soora-samharam-south-devotional-household-participant-2027-v1",
        "subrahmanya-sashti-south-devotional-household-participant-2027-v1",
        "karthigai-deepam-south-devotional-household-participant-2027-v1",
        "karadaiyan-nombu-regional-family-household-participant-2027-v1",
        "gangaur-regional-family-household-participant-2027-v1",
        "jayaparvati-vrat-regional-family-household-participant-2027-v1",
        "kokila-vrat-regional-family-household-participant-2027-v1",
        "hariyali-teej-regional-family-household-participant-2027-v1",
        "kajari-teej-regional-family-household-participant-2027-v1",
        "kevda-trij-regional-family-household-participant-2027-v1",
        "atla-tadde-regional-family-household-participant-2027-v1",
        "matsyavathara-dinam-avatar-remembrance-household-participant-2027-v1",
        "parashurama-jayanti-avatar-remembrance-household-participant-2027-v1",
        "narasimha-jayanti-avatar-remembrance-household-participant-2027-v1",
        "kurma-jayanti-avatar-remembrance-household-participant-2027-v1",
        "kurmavathara-dinam-avatar-remembrance-household-participant-2027-v1",
        "kalki-jayanti-avatar-remembrance-household-participant-2027-v1",
        "varaha-jayanti-avatar-remembrance-household-participant-2027-v1",
        "balarama-jayanti-avatar-remembrance-household-participant-2027-v1",
        "vamana-jayanti-avatar-remembrance-household-participant-2027-v1",
        "vasudeva-chaturthi-monthly-vinayaka-household-participant-2027-v1",
        "sankarshana-chaturthi-monthly-vinayaka-household-participant-2027-v1",
        "pradyumna-chaturthi-monthly-vinayaka-household-participant-2027-v1",
        "aniruddha-chaturthi-monthly-vinayaka-household-participant-2027-v1",
        "ganga-dussehra-river-observance-household-participant-2027-v1",
        "ganga-puja-river-observance-household-participant-2027-v1",
        "ganga-saptami-river-observance-household-participant-2027-v1",
        "yamuna-chhath-river-observance-household-participant-2027-v1",
        "chandra-grahan-upachchaya-eclipse-observance-household-2027-v1",
        "surya-grahan-purna-eclipse-observance-household-participant-2027-v1",
        "surya-grahan-valayakara-eclipse-observance-household-participant-2027-v1",
        "basoda-north-india-sheetala-household-2027-v1",
        "sheetala-ashtami-north-india-deity-household-2027-v1",
        "shitala-satam-gujarat-household-participant-2027-v1",
        "nag-panchami-multi-regional-animal-safe-household-2027-v1",
        "nagula-chavithi-telugu-animal-safe-household-2027-v1",
        "garuda-panchami-south-india-household-temple-participant-2027-v1",
        "bol-choth-gujarat-cattle-safe-household-2027-v1",
        "pola-maharashtra-chhattisgarh-cattle-safe-participant-2027-v1",
        "vrishabhotsava-bull-nandi-owner-routed-household-2027-v1",
        "ratha-saptami-surya-household-participant-2027-v1",
        "bhanu-saptami-recurring-surya-household-2027-v1",
        "shani-jayanti-amavasya-household-temple-participant-2027-v1",
        "shani-trayodashi-recurring-owner-routed-household-2027-v1",
        "ashtami-rohini-kerala-krishna-household-temple-participant-2027-v1",
        "hanuman-jayanthi-tamil-household-temple-participant-2027-v1",
        "hanuman-puja-gujarat-diwali-household-temple-participant-2027-v1",
        "jagannath-ratha-yatra-odisha-participant-2027-v1",
        "krishna-janmashtami-north-shared-household-temple-participant-2027-v1",
        "masika-krishna-janmashtami-recurring-household-2027-v1",
        "parashurama-dwadashi-telugu-household-2027-v1",
        "shankara-jayanti-south-institution-owner-routed-2027-v1",
        "vamana-dwadashi-telugu-household-2027-v1",
        "vaishnava-papanasini-ekadashi-authority-router-2027-v1",
        "akshaya-navami-north-household-participant-2027-v1",
        "andolana-trutiya-telugu-owner-routed-household-2027-v1",
        "bhishma-ashtami-north-household-authority-router-2027-v1",
        "champa-shashthi-maharashtra-khandoba-owner-routed-2027-v1",
        "chandra-darshana-recurring-household-2027-v1",
        "dattatreya-jayanti-west-south-household-temple-participant-2027-v1",
        "dharo-atham-gujarat-owner-routed-household-2027-v1",
        "gayatri-jayanti-matantara-household-owner-routed-2027-v1",
        "gopalakala-maharashtra-consent-safe-participant-2027-v1",
        "guruvayur-ekadasi-kerala-temple-participant-2027-v1",
        "jalaram-bapa-jayanti-gujarat-service-household-participant-2027-v1",
        "jamai-shashti-bengal-consent-led-family-2027-v1",
        "kalashtami-recurring-bhairava-household-owner-routed-2027-v1",
        "kamanahabba-karnataka-fire-safe-owner-routed-2027-v1",
        "kansa-vadh-braj-story-participant-2027-v1",
        "masi-magam-tamil-household-temple-participant-2027-v1",
        "narada-jayanti-household-story-owner-routed-2027-v1",
        "ranga-panchami-west-central-consent-safe-2027-v1",
        "simhasta-kumbha-nashik-live-authority-participant-2027-v1",
        "sita-navami-north-household-participant-2027-v1",
        "swaminarayan-jayanti-institution-owner-routed-2027-v1",
        "thrissur-pooram-kerala-live-event-participant-2027-v1",
    ]
    assert progress["completed_umbrella_components"] == {
        ...
        "pitru-paksha-delhi-remembrance-content-v1": [
            "purnima-shraddha-north-west-authority-router-2027-v1",
            "pratipada-shraddha-north-west-authority-router-2027-v1",
            "dwitiya-shraddha-north-west-authority-router-2027-v1",
            "tritiya-shraddha-north-west-authority-router-2027-v1",
    ...
    assert progress["non_denominator_utility_lane_ids"] == [
        "dwadashi-shraddha-north-west-authority-router-2027-v1",
        "trayodashi-shraddha-north-west-authority-router-2027-v1",
    ]
...
def test_magha_shraddha_authority_router_links_progress_and_adversarial_contract():
    content_schema = load(ROOT / "schemas" / "ritual-observance-content-v1.schema.json")
    link_schema = load(ROOT / "schemas" / "cross-lane-link-proposal-v1.schema.json")
    pack = load(MAGHA_SHRADDHA_PACK)
    Draft202012Validator(content_schema).validate(pack)
    assert pack["lane_id"] == "magha-shraddha-north-west-authority-router-2027-v1"
    assert pack["observance_slugs"] == ["magha-shraddha"]
    assert {"north-india", "west-india", "IN-WB", "IN-BR", "IN-CG", "IN-KA", "IN-TN", "IN-KL", "IN-MH", "IN-OD", "IN-AP"} <= set(pack["applicability"]["region_codes"])
    assert "authority-routed-shraddha" in pack["applicability"]["tradition_codes"]
    assert pack["calendar"]["timing_kind"] == "mixed"
    assert pack["calendar"]["location_aware"] and pack["calendar"]["tradition_aware"]
    freshness = pack["calendar"]["freshness_note"]
    assert "Monday 27 September 2027" in freshness
    assert "beside Dwadashi" in freshness and "longer overlap" in freshness
    assert "Magha-Trayodashi conjunction" in freshness
    assert "Never copy the date, interval, Dwadashi label, formal window, ancestor, performer" in freshness
    ...
    walk(pack)
    assert set(refs) <= source_ids
    assert {"drik-pitru-paksha-new-delhi-2027", "drik-magha-shraddha-rule-current", "drik-magha-nakshatra-panagar-2027", "utsav-pitra-paksha", "nirnayasindhu-1865-mahalaya-section", "max-muller-katha-upanishad", "devam-pitru-paksha-2026", "devam-pitru-remembrance-content", "devam-final-disposition", "devam-maha-bharani-lane", "devam-sarva-pitru-lane", "india-emergency-112", "devam-magha-shraddha-research"} == source_ids
    assert next(source for source in pack["sources"] if source["source_id"] == "max-muller-katha-upanishad")["rights_lane"] == "product_cleared"
    assert next(source for source in pack["sources"] if source["source_id"] == "nirnayasindhu-1865-mahalaya-section")["artifact_sha256"] == "a632f570153cb77802b85fdc22e54e00f217960b1d848ee640dd9e610327f02b"
    ...
    english = json.dumps(localized["en"], ensure_ascii=False).lower()
    for term in ("same-day dwadashi label does not define magha", "longer overlap selects the day", "magha trayodashi case", "not magha shraddha's origin or shraddha vidhi", "good from the merely pleasant", "reject calendar-only or ‘every son’ assignment", "do not assemble pinda, til, kusa", "honey, kheer", "attributed claims, not devam facts or guarantees", "language, spelling, dress"):
        assert term in english
    for forbidden in ("every hindu must", "every son must", "only men may", "women cannot perform", "you must fast", "bathe in a river", "make a pinda", "offer honey", "feed a cow", "donation is mandatory", "your ancestors are satisfied", "pitru dosha has been removed", "vishnu-loka is guaranteed", "marriage is guaranteed", "progeny is guaranteed", "a child should obey the father", "every state needs a separate ritual"):
        assert forbidden not in english

    raw = MAGHA_SHRADDHA_PACK.read_bytes(); raw.decode("utf-8", errors="strict")
    for phrase in ("मघा श्राद्ध", "longer overlap", "Pitru Dosha diagnose न करें", "all-sons rule नहीं"):
        assert phrase.encode("utf-8") in raw
    assert b"\xef\xbf\xbd" not in raw and MAGHA_SHRADDHA_PACK.stat().st_size < 100_000

    links = load(MAGHA_SHRADDHA_LINK); Draft202012Validator(link_schema).validate(links)
    assert len(links["proposals"]) == 7
    by_id = {proposal["proposal_id"]: proposal for proposal in links["proposals"]}
    for proposal_id in ("magha-to-existing-pitru-remembrance", "magha-to-maha-bharani", "magha-to-sarva-pitru"):
        assert by_id[proposal_id]["target_resolution"] == "lane_local"
    for proposal_id in ("magha-to-formal-owner", "magha-to-trayodashi-overlap-owner", "magha-to-nachiketa-story", "magha-to-named-place-owner"):
        assert by_id[proposal_id]["target_resolution"] == "unresolved_owner_lane"
    assert by_id["magha-to-maha-bharani"]["directionality"] == "bidirectional"
    assert by_id["magha-to-sarva-pitru"]["directionality"] == "bidirectional"
...
def test_dwadashi_shraddha_authority_router_links_progress_and_adversarial_contract():
    content_schema = load(ROOT / "schemas" / "ritual-observance-content-v1.schema.json")
    link_schema = load(ROOT / "schemas" / "cross-lane-link-proposal-v1.schema.json")
    pack = load(DWADASHI_SHRADDHA_PACK)
    Draft202012Validator(content_schema).validate(pack)
    assert pack["lane_id"] == "dwadashi-shraddha-north-west-authority-router-2027-v1"
    assert pack["observance_slugs"] == ["dwadashi-shraddha"]
    assert {"north-india", "west-india", "IN-WB", "IN-BR", "IN-CG", "IN-KA", "IN-TN", "IN-KL", "IN-MH", "IN-OD", "IN-AP"} <= set(pack["applicability"]["region_codes"])
    assert "authority-routed-shraddha" in pack["applicability"]["tradition_codes"]
    assert pack["calendar"]["timing_kind"] == "mixed"
    assert pack["calendar"]["location_aware"] and pack["calendar"]["tradition_aware"]
    freshness = pack["calendar"]["freshness_note"]
    assert "Monday 27 September 2027" in freshness and "beside Magha Shraddha" in freshness
    assert "greater Dwadashi-aparahna overlap" in freshness
    assert "ties, kshaya/vriddhi or sampradaya exceptions unresolved" in freshness
    assert "Never copy the date, interval, formal window, Magha label, ancestor, Sannyasi/Vaishnava classification" in freshness
    ...
    walk(pack)
    assert set(refs) <= source_ids
    assert {"drik-pitru-paksha-new-delhi-2027", "drik-dwadashi-shraddha-new-delhi-2027", "utsav-pitra-paksha", "nirnayasindhu-1865-mahalaya-section", "max-muller-katha-upanishad", "devam-pitru-paksha-2026", "devam-pitru-remembrance-content", "devam-selected-scope", "devam-magha-shraddha-lane", "devam-sarva-pitru-lane", "india-emergency-112", "devam-dwadashi-shraddha-research"} == source_ids
    assert next(source for source in pack["sources"] if source["source_id"] == "max-muller-katha-upanishad")["rights_lane"] == "product_cleared"
    assert next(source for source in pack["sources"] if source["source_id"] == "nirnayasindhu-1865-mahalaya-section")["artifact_sha256"] == "a632f570153cb77802b85fdc22e54e00f217960b1d848ee640dd9e610327f02b"
    ...
    english = json.dumps(localized["en"], ensure_ascii=False).lower()
    for term in ("same-date magha is a distinct nakshatra route", "route an unknown death tithi to sarva", "greater dwadashi-aparahna overlap", "sannyasi/vaishnava exception", "not dwadashi origin, sannyasi classification or vidhi", "good from the merely pleasant", "do not assemble pinda, til, kusa", "sahasranama text", "attributed claims, not devam facts or guarantees", "language, spelling, dress"):
        assert term in english
    for forbidden in ("every hindu must", "every son must", "only men may", "women cannot perform", "every disciple must", "you must fast", "bathe in a river", "make a pinda", "recite vishnu sahasranama", "feed brahmins", "donate clothes", "your ancestors are satisfied", "you will attain vishnu-loka", "eternal peace is guaranteed", "prosperity is guaranteed", "a child should obey the father", "every state needs a separate ritual"):
        assert forbidden not in english

    raw = DWADASHI_SHRADDHA_PACK.read_bytes(); raw.decode("utf-8", errors="strict")
    for phrase in ("द्वादशी श्राद्ध", "Unknown death tithi Sarva", "Sannyasi/Vaishnava classify न करें", "greater Dwadashi-aparahna overlap"):
        assert phrase.encode("utf-8") in raw
    assert b"\xef\xbf\xbd" not in raw and DWADASHI_SHRADDHA_PACK.stat().st_size < 100_000

    links = load(DWADASHI_SHRADDHA_LINK); Draft202012Validator(link_schema).validate(links)
    assert len(links["proposals"]) == 7
    by_id = {proposal["proposal_id"]: proposal for proposal in links["proposals"]}
    for proposal_id in ("dwadashi-to-existing-remembrance", "dwadashi-to-magha", "dwadashi-to-sarva-pitru"):
        assert by_id[proposal_id]["target_resolution"] == "lane_local"
    for proposal_id in ("dwadashi-to-formal-owner", "dwadashi-to-sannyasi-vaishnava-owner", "dwadashi-to-nachiketa-story", "dwadashi-to-named-place-owner"):
        assert by_id[proposal_id]["target_resolution"] == "unresolved_owner_lane"
    assert by_id["dwadashi-to-magha"]["directionality"] == "bidirectional"
    assert by_id["dwadashi-to-sarva-pitru"]["predicate"] == "routes_unknown_death_tithi_to"
