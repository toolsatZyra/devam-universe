...
across 49 story turns and 413 substantial bilingual scenes containing 1,794
...
visual direction, and compiled traversal links. Seventeen exact data-only
scenes now replace six formerly compressed blocks across coronation dawn,
deeper forest, Panchavati, Janasthana, and the golden-deer plot;
...
than 35 orientation turns, or the whole 413-scene corpus as already illustrated
