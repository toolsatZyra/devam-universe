...
| D5 | Ramayana explorer | The Atlas exposes Ramayana; Search and Sarthi reach the locally prepared 813-page proofread/validated Ramcharitmanas slice with seven sopana anchors and the explicit 359-page unproofread/empty exclusion; hosted application remains a separate authorized step | Playwright Atlas, Search and Sarthi tests plus local compiler report and separately versioned hosted report |
