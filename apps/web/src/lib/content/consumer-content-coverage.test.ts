...
describe("consumer-content MVP inventory", () => {
  ...
  it("records the honest Ramayana and Ramcharitmanas starting denominators", () => {
    ...
    expect(ramayana.current).toMatchObject({
      ...
      supplemental_expected_story_rows_complete_en_hi: 12,
      supplemental_expected_story_rows_open: 10,
      ...
      supplemental_bilingual_episode_beats: 140,
      total_selected_and_supplemental_bilingual_narrative_units: 2480,
