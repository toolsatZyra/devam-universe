...
describe("consumer-content MVP inventory", () => {
  ...
  it("records the honest Ramayana and Ramcharitmanas starting denominators", () => {
    ...
    expect(ramayana.current).toMatchObject({
      ...
      supplemental_expected_story_rows_complete_en_hi: 7,
      supplemental_expected_story_rows_open: 15,
      ...
      supplemental_bilingual_episode_beats: 69,
      total_selected_and_supplemental_bilingual_narrative_units: 2409,
