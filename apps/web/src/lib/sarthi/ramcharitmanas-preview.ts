...
export function searchRamcharitmanasPreview(query: string, languageCode?: string) {
  ...
  return [{
    ...
    statement: hindi
      ...
      : "Devam's prepared product projection contains all 813 proofread or validated beta pages across the seven sopanas of one fixed Belvedere Press Ramcharitmanas edition; 359 unproofread or empty pages remain outside retrieval.",
...
export function answerRamcharitmanasPreview(request: SarthiRequest): GroundedSarthiAnswer | null {
  ...
  return {
    ...
    answer: hindi
      ...
      : "Ramcharitmanas is Tulsidas's Awadhi devotional telling of the Rama story. Devam's prepared product projection contains all 813 proofread or validated beta pages across the seven sopanas—Bala, Ayodhya, Aranya, Kishkindha, Sundara, Lanka, and Uttara—from one fixed Belvedere Press edition. Another 359 unproofread or empty pages remain outside retrieval, so this is not the complete Ramcharitmanas tradition.",
    citations: citations(),
