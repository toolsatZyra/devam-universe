...
describe("Ramayana whole-epic story compass", () => {
  ...
  it("distinguishes mapped orientation from the five playable district entrances", () => {
    ...
    expect(Object.values(compass.turns).filter((turn) => turn.coverage === "orientation")).toHaveLength(44);
