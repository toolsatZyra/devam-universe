...
const placesByTurn: Record<string, string[]> = {
  ...
  "bharata-follows": ["Ayodhya", "The road prepared for Rama", "Shringaverapura", "The expedition at the Ganga", "The grass beneath the Ingudi tree", "Bharadvaja's impossible welcome", "The smoke above Chitrakoot", "Chitrakuta"],
  "sandals-and-promise": ["Chitrakuta", "The cottage of reunion", "The family council by the Mandakini", "The council of the sandals", "Nandigrama"],
  "deeper-into-forest": ["Chitrakuta", "The hermitages leave Chitrakoot", "Atri and Anasuya's hermitage", "Dandaka"],
  "dandaka-vows": ["Dandaka", "The hermitage constellation of Dandaka", "Viradha's broken road", "The road from Sarabhanga to Sutikshna", "The dialogue on the forest road", "Panchapsara and the ten-year forest", "Agastya's southern hermitage"],
  "panchavati-surpanakha": ["Panchavati", "Jatayu's Panchavati threshold", "The cottage at Panchavati"],
  "war-at-janasthana": ["Janasthana", "The Janasthana battlefield"],
  "golden-deer-plot": ["Lanka", "Panchavati", "Ravana's road to Maricha", "The golden deer path"],
  "sita-is-taken": ["Panchavati", "The emptied Panchavati cottage", "The southward sky-road", "Jatayu's last resistance"],
...
export function buildRamayanaCompass(): StoryCompass {
  ...
  return {
    ...
    sourceBoundary: "This compass covers all 652 source-ordered units derived from the printed headings in this selected English expression exactly once; the electronic edition retains heading-number transcription anomalies. It is not Sanskrit, a critical edition, every recension, or the complete Ramayana tradition. A mapped turn is orientation, not a finished playable scene.",
