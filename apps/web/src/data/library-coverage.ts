...
export const LIBRARY_COVERAGE_SNAPSHOT = {
  ...
  heroes: [
    ...
    },
    {
      ...
      name: "Ramayana",
      devanagari: "रामायण",
      connected: "A published product-usable seven-kanda, 606-sarga Ambuda/DCS Sanskrit electronic corpus with 46 literal record gaps and three source-order anomalies exposed; a published source-addressed Griffith English layer with six books and explicit omissions; complete narrative-body coverage of the four-volume Dutt English electronic edition across all seven kandas and 652 byte-addressed sections, with literal numbering defects preserved; all seven edition-matched Dutt scans; one structurally complete public-domain seven-sopana Belvedere Ramcharitmanas scan; and all 1,240 edition-matched Hindi Wikisource page revisions, including 813 proofread or validated narrative-page product candidates and an explicit 359-page correction queue; journey, challenge, Search, and Sarthi orientation.",
