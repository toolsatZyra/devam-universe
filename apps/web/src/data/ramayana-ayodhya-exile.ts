...
export const RAMAYANA_AYODHYA_MOMENTS: Record<string, StoryMoment> = {
  ...
  "manthara-sees-city": {
    ...
    beats: [
      ...
      { id: "kaikeyi-first-rejoices", title: { en: "Kaikeyi first rejoices", hi: "कैकेयी पहले प्रसन्न होती हैं" }, narration: { en: "Kaikeyi does not begin in anger. She delights in the news, praises Rama, and gives Manthara an ornament—an important beginning before persuasion changes her.", hi: "कैकेयी आरंभ में क्रोधित नहीं होतीं। वे समाचार से प्रसन्न होकर राम की प्रशंसा करती हैं और मंथरा को आभूषण देती हैं—तर्क से बदलने से पहले यही उनका शुरुआती भाव है।" }, visualCue: "Kaikeyi offers a jewel in an open, warmly lit chamber.", characterIds: ["kaikeyi", "manthara", "rama"] },
      { id: "gift-is-thrown-aside", title: { en: "The gift is thrown aside", hi: "उपहार फेंक दिया जाता है" }, narration: { en: "Manthara rejects the gift and insists Kaikeyi is celebrating her own loss. The room changes from congratulations into an argument about power and security.", hi: "मंथरा उपहार अस्वीकार कर कहती है कि कैकेयी अपनी ही हानि का उत्सव मना रही हैं। कक्ष में बधाई की जगह सत्ता और सुरक्षा की बहस शुरू होती है।" }, visualCue: "A bright ornament lands between two figures as the room cools into shadow.", characterIds: ["manthara", "kaikeyi"] },
    ],
  },
  ...
  "king-trapped-by-word": {
    ...
    beats: [
      { id: "dasharatha-collapses", title: { en: "The demand lands", hi: "माँग का आघात" }, narration: { en: "Dasharatha falls senseless, recovers, and hopes he has heard a nightmare. Kaikeyi repeats the demands without softening them.", hi: "दशरथ मूर्छित होकर गिरते हैं, संभलते हैं और आशा करते हैं कि यह दुःस्वप्न हो। कैकेयी बिना नरमी के माँगें दोहराती हैं।" }, visualCue: "The king collapses beside coronation vessels that now seem impossibly distant.", characterIds: ["king-dasharatha", "kaikeyi"] },
      { id: "king-pleads-through-night", title: { en: "A king pleads through the night", hi: "राजा पूरी रात विनती करते हैं" }, narration: { en: "He appeals to love, reputation, family, and mercy. He offers wealth and power, but cannot make Kaikeyi release the promise.", hi: "वे प्रेम, प्रतिष्ठा, परिवार और दया की दुहाई देते हैं। धन और सत्ता देने को तैयार होते हैं, पर कैकेयी वचन छोड़ने को नहीं मानतीं।" }, visualCue: "Night deepens through carved windows while the argument circles without escape.", characterIds: ["king-dasharatha", "kaikeyi"] },
      { id: "kaikeyi-invokes-truth", title: { en: "Kaikeyi invokes the king's truth", hi: "कैकेयी राजा के सत्य का आह्वान करती हैं" }, narration: { en: "Kaikeyi says a king celebrated for truth cannot withdraw when the cost becomes painful. The language of honour becomes the lock on the chamber.", hi: "कैकेयी कहती हैं कि सत्य के लिए प्रसिद्ध राजा कठिन मूल्य देखकर पीछे नहीं हट सकता। सम्मान की भाषा ही कक्ष का ताला बन जाती है।" }, visualCue: "A luminous thread binds a royal seal to the darkened doorway.", characterIds: ["kaikeyi", "king-dasharatha"] },
      { id: "morning-waits-outside", title: { en: "Morning waits outside", hi: "सुबह बाहर प्रतीक्षा करती है" }, narration: { en: "Priests, citizens, music, and the objects of installation gather outside. Inside, Dasharatha can no longer speak the future everyone has come to celebrate.", hi: "पुरोहित, नागरिक, संगीत और अभिषेक-सामग्री बाहर जुटते हैं। भीतर दशरथ उस भविष्य का नाम भी नहीं ले पाते जिसके उत्सव में सब आए हैं।" }, visualCue: "Golden morning presses against a sealed, shadowed royal chamber.", characterIds: ["king-dasharatha", "kaikeyi", "vasishta"] },
    ],
  },
