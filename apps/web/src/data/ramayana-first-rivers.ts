...
export const RAMAYANA_FIRST_RIVERS_MOMENTS: Record<string, StoryMoment> = {
  ...
  "chitrakoot-home": {
    ...
    beats: [
      ...
      { id: "valmiki-welcomes-them", title: { en: "A hermitage receives them", hi: "एक आश्रम उन्हें स्वीकारता है" }, narration: { en: "In this selected Dutt edition, the travellers greet Valmiki and explain their journey. The district keeps that edition-specific sequence without claiming every Ramayana places the encounter here.", hi: "इस चुने हुए दत्त संस्करण में यात्री वाल्मीकि को प्रणाम कर अपनी यात्रा बताते हैं। यह जिला इसी संस्करण-विशिष्ट क्रम को रखता है, इसे हर रामायण का क्रम नहीं कहता।" }, visualCue: "A forest sage welcomes the three at the edge of a modest hermitage.", characterIds: ["rama", "sita", "lakshmana"] },
