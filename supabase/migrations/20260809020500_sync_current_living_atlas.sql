...
from (values
  ('ramayana-to-diwali', 'ramayana', 'diwali', 'Rama homecoming tradition', 'The Rama-Sita-Lakshmana return to Ayodhya is a major North Indian Diwali story connection, not the origin account or theological meaning of every Diwali, Deepavali, Jain, Sikh, Shakta, Vaishnava, or regional tradition.'),
  ('ramayana-ayodhya', 'ramayana', 'ayodhya', 'begins in', null),
  ('ramayana-chitrakoot', 'ramayana', 'chitrakoot', 'journey through', null),
  ('ganesha-ashtavinayak', 'ganesha', 'ashtavinayak', 'pilgrimage tradition', null),
  ('ganesha-ujjain', 'ganesha', 'ujjain', 'living worship', null),
  ('durga-kamakhya', 'durga', 'kamakhya', 'Shakti tradition', null),
  ('durga-kolkata', 'durga', 'kolkata', 'Durga Puja', null),
  ('durga-kanchipuram', 'durga', 'kanchipuram', 'Shakti tradition', null),
  ('diwali-kolkata', 'diwali', 'kolkata', 'Kali Puja', null),
  ('diwali-to-kali-puja', 'diwali', 'kali-puja', 'same new-moon night, distinct Bengal festival', 'Kali Puja often coincides with the Diwali new-moon night in Bengal and neighbouring regions, but it remains a distinct Shakta festival and is not relabelled as Lakshmi Puja or a universal Diwali practice.'),
  ('diwali-pavapuri', 'diwali', 'pavapuri', 'Jain Diwali', null),
  ('diwali-amritsar', 'diwali', 'amritsar', 'Bandi Chhor Divas', null),
  ('diwali-nathdwara', 'diwali', 'nathdwara', 'Annakut tradition', null),
  ('diwali-kashi', 'diwali', 'kashi', 'Dev Deepawali', null),
  ('ramayana-bala-kanda', 'ramayana', 'bala-kanda', 'opens with', null),
  ('ramayana-ramcharitmanas', 'ramayana', 'ramcharitmanas', 'Awadhi devotional telling', null),
  ('ramayana-dutt-ramayana', 'ramayana', 'dutt-ramayana', 'English prose edition', null),
  ('bala-to-ayodhya-kanda', 'bala-kanda', 'ayodhya-kanda', 'continues into', null),
  ('ayodhya-kanda-to-ayodhya', 'ayodhya-kanda', 'ayodhya', 'text and place thread', null),
  ('ayodhya-to-chitrakoot', 'ayodhya', 'chitrakoot', 'journey toward', null),
  ('chitrakoot-to-aranya', 'chitrakoot', 'aranya-kanda', 'forest journey', null),
  ('aranya-to-kishkindha', 'aranya-kanda', 'kishkindha-kanda', 'continues into', null),
  ('kishkindha-to-sundara', 'kishkindha-kanda', 'sundara-kanda', 'mission continues', null),
  ('sundara-to-hanuman-deliberation', 'sundara-kanda', 'hanuman-deliberation', 'contains episode', null),
  ('sundara-to-yuddha', 'sundara-kanda', 'yuddha-kanda', 'continues into', null),
  ('yuddha-to-uttara', 'yuddha-kanda', 'uttara-kanda', 'continues into', null),
  ('ganesha-ganesh-chaturthi', 'ganesha', 'ganesh-chaturthi', 'annual festival', null),
  ('ganesha-ganesha-purana', 'ganesha', 'ganesha-purana', 'source text', null),
  ('ganesha-ganapatyatharvashirsha', 'ganesha', 'ganapatyatharvashirsha', 'source text', null),
  ('ganesha-sankashti', 'ganesha', 'sankashti-chaturthi', 'recurring observance', null),
  ('ganesh-chaturthi-to-ananta', 'ganesh-chaturthi', 'ananta-chaturdashi', 'some festival closings', null),
  ('ganesh-chaturthi-to-ashtavinayak', 'ganesh-chaturthi', 'ashtavinayak', 'Maharashtra Ganesha world', null),
  ('durga-devi-mahatmya', 'durga', 'devi-mahatmya', 'scriptural source', null),
  ('devi-mahatmya-madhu-kaitabha', 'devi-mahatmya', 'madhu-kaitabha', 'contains narrative of', null),
  ('devi-mahatmya-mahishasura', 'devi-mahatmya', 'mahishasura', 'contains narrative of', null),
  ('devi-mahatmya-shumbha', 'devi-mahatmya', 'shumbha', 'contains narrative of', null),
  ('devi-mahatmya-nishumbha', 'devi-mahatmya', 'nishumbha', 'contains narrative of', null),
  ('durga-navaratri', 'durga', 'shardiya-navaratri', 'nine-night sequence', null),
  ('durga-to-durga-puja', 'durga', 'durga-puja', 'living festival world', 'Durga Puja is a major living Durga festival, especially prominent in Bengal, while its community, household, regional, and ritual forms remain separately attributable.'),
  ('durga-puja-to-kolkata', 'durga-puja', 'kolkata', 'Kolkata public art and worship', 'Kolkata is a major living centre of Durga Puja and public festival art; the place connection is not a claim that the city contains every Durga Puja tradition or that all pandals and households follow one practice.'),
  ('navaratri-to-maha-ashtami', 'shardiya-navaratri', 'maha-ashtami', 'regional day path', null),
  ('navaratri-to-saraswati-ayudha', 'shardiya-navaratri', 'saraswati-ayudha-puja', 'Karnataka Navami path', null),
  ('maha-ashtami-to-kolkata', 'maha-ashtami', 'kolkata', 'Bengal participant context', null),
  ('saraswati-ayudha-to-kanchipuram', 'saraswati-ayudha-puja', 'kanchipuram', 'South India exploration', null),
  ('diwali-vasu-baras', 'diwali', 'vasu-baras', 'Maharashtra opening', null),
  ('vasu-to-dhanteras', 'vasu-baras', 'dhantrayodashi', 'festival sequence', null),
  ('dhanteras-to-yama', 'dhantrayodashi', 'yama-deepam', 'separate lamp practice', null),
  ('dhanteras-to-naraka', 'dhantrayodashi', 'naraka-chaturdashi', 'festival sequence', null),
  ('naraka-to-lakshmi', 'naraka-chaturdashi', 'lakshmi-puja', 'West India sequence', null),
  ('naraka-to-tamil', 'naraka-chaturdashi', 'tamil-deepavali', 'distinct regional world', null),
  ('lakshmi-to-kali', 'lakshmi-puja', 'kali-puja', 'same night, distinct practice', null),
  ('kali-to-kolkata', 'kali-puja', 'kolkata', 'Bengal context', null),
  ('kali-puja-to-durga', 'kali-puja', 'durga', 'connected Shakta goddess traditions', 'Kali and Durga are connected within multiple Shakta textual and devotional frameworks, including the Devi Mahatmya, but Devam does not flatten their forms, theologies, temples, festivals, or living lineages into equivalence.'),
  ('lakshmi-to-bali', 'lakshmi-puja', 'bali-pratipada', 'Maharashtra sequence', null),
  ('lakshmi-to-govardhana', 'lakshmi-puja', 'govardhana-puja', 'Vaishnava sequence', null),
  ('govardhana-to-nathdwara', 'govardhana-puja', 'nathdwara', 'Annakut exploration', null),
  ('bali-to-bhai-dooj', 'bali-pratipada', 'bhai-dooj', 'festival sequence', null),
  ('naraka-to-kali-chaudas-baps', 'naraka-chaturdashi', 'kali-chaudas-baps', 'distinct Gujarat lane', null),
  ('bali-to-gujarati-new-year-baps', 'bali-pratipada', 'gujarati-new-year-baps', 'distinct Gujarat New Year', null),
  ('bali-to-balipadyami-karnataka', 'bali-pratipada', 'balipadyami-karnataka', 'distinct Karnataka lane', null),
  ('diwali-to-jain-diwali', 'diwali', 'jain-diwali', 'Jain remembrance tradition', null),
  ('diwali-to-bandi-chhor-divas', 'diwali', 'bandi-chhor-divas', 'seasonal Sikh remembrance', null)
