...
begin
  ...
  where slug = any (array['ramayana', 'ganesha', 'durga', 'diwali', 'ayodhya', 'chitrakoot', 'ashtavinayak', 'ujjain', 'kamakhya', 'kolkata', 'kashi', 'kanchipuram', 'pavapuri', 'amritsar', 'nathdwara', 'ramcharitmanas', 'bala-kanda', 'ayodhya-kanda', 'aranya-kanda', 'kishkindha-kanda', 'sundara-kanda', 'hanuman-deliberation', 'yuddha-kanda', 'uttara-kanda', 'ganesh-chaturthi', 'sankashti-chaturthi', 'ananta-chaturdashi', 'devi-mahatmya', 'shardiya-navaratri', 'maha-ashtami', 'saraswati-ayudha-puja', 'vasu-baras', 'dhantrayodashi', 'yama-deepam', 'naraka-chaturdashi', 'lakshmi-puja', 'kali-puja', 'bali-pratipada', 'govardhana-puja', 'bhai-dooj', 'tamil-deepavali'])
