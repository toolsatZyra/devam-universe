...
from (values
  ...
  ('ramayana-dutt-ramayana', 'ramayana', 'dutt-ramayana', 'English prose edition'),
  ...
  ('ganesha-ganesha-purana', 'ganesha', 'ganesha-purana', 'source text'),
  ('ganesha-ganapatyatharvashirsha', 'ganesha', 'ganapatyatharvashirsha', 'source text'),
  ...
  ('naraka-to-kali-chaudas-baps', 'naraka-chaturdashi', 'kali-chaudas-baps', 'distinct Gujarat lane'),
  ('bali-to-gujarati-new-year-baps', 'bali-pratipada', 'gujarati-new-year-baps', 'distinct Gujarat New Year'),
  ('bali-to-balipadyami-karnataka', 'bali-pratipada', 'balipadyami-karnataka', 'distinct Karnataka lane'),
  ('diwali-to-jain-diwali', 'diwali', 'jain-diwali', 'Jain remembrance tradition'),
  ('diwali-to-bandi-chhor-divas', 'diwali', 'bandi-chhor-divas', 'seasonal Sikh remembrance')
